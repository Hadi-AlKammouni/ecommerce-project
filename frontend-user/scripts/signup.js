...
let register_btn = document.getElementById("signup-page-btn");
...
function register(){
    ...
    if (username.value != "" && email.value != "" && password.value != "" && password_confirmation.value != ""){
        ...
        if(username.value.length >= 2){
            ...
            alert("username must be minimum two characters");
        }
        ...
        if(password_confirmation.value.length >= 6 && password.value == password_confirmation.value){
            ...
            alert("password & password_confirmation must be identical & minimum six characters");
        }
